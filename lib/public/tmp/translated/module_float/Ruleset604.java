...
L345:
		{
			if (execL342(var0,nondeterministic)) {
				ret = true;
				break L345;
			}
		}
	...
	public boolean execL342(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L342:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L343",var0});
			} else if (execL343(var0,nondeterministic)) {
				ret = true;
				break L342;
			}
		}
