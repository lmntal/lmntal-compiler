...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL485(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@608", "null");
			return true;
		}
	...
	public boolean execL485(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L485:
		{
			if (execL482(var0,nondeterministic)) {
				ret = true;
				break L485;
			}
		}
...
L482:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L483",var0});
			} else if (execL483(var0,nondeterministic)) {
				ret = true;
				break L482;
			}
		}
	...
	public boolean execL483(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L484:
	...
	private static final Functor f0 = new Functor("float", 1, null);
}
