...
L1219:
		{
			if (execL1216(var0,nondeterministic)) {
				ret = true;
				break L1219;
			}
		}
	...
	public boolean execL1216(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1216:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1217",var0});
			} else if (execL1217(var0,nondeterministic)) {
				ret = true;
				break L1216;
			}
		}
...
L1217:
	...
	public boolean execL1218(Object var0, Object var1, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
