...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL191(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@604", "null");
			return true;
		}
	...
	public boolean execL191(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L191:
		{
			if (execL188(var0,nondeterministic)) {
				ret = true;
				break L191;
			}
		}
...
L188:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L189",var0});
			} else if (execL189(var0,nondeterministic)) {
				ret = true;
				break L188;
			}
		}
