...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1566(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@618", "null");
			return true;
		}
	...
	public boolean execL1566(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L1566:
		{
			if (execL1563(var0,nondeterministic)) {
				ret = true;
				break L1566;
			}
		}
	...
	public boolean execL1563(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1563:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1564",var0});
			} else if (execL1564(var0,nondeterministic)) {
				ret = true;
				break L1563;
			}
		}
	...
	public boolean execL1564(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
