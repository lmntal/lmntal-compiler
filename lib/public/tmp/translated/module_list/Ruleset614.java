...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1505(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@614", "null");
			return true;
		}
	...
	public boolean execL1505(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L1505:
		{
			if (execL1502(var0,nondeterministic)) {
				ret = true;
				break L1505;
			}
		}
	...
	public boolean execL1502(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1502:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1503",var0});
			} else if (execL1503(var0,nondeterministic)) {
				ret = true;
				break L1502;
			}
		}
	...
	public boolean execL1503(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L1503:
	...
	public boolean execL1504(Object var0, Object var1, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
