...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1760(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@618", "null");
			return true;
		}
	...
	public boolean execL1760(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L1760:
		{
			if (execL1757(var0,nondeterministic)) {
				ret = true;
				break L1760;
			}
		}
	...
	public boolean execL1757(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1757:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1758",var0});
			} else if (execL1758(var0,nondeterministic)) {
				ret = true;
				break L1757;
			}
		}
	...
	public boolean execL1758(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L1758:
	...
	public boolean execL1759(Object var0, Object var1, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
