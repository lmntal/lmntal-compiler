...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1614(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@616", "null");
			return true;
		}
	...
	public boolean execL1614(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L1614:
		{
			if (execL1611(var0,nondeterministic)) {
				ret = true;
				break L1614;
			}
		}
	...
	public boolean execL1611(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1611:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1612",var0});
			} else if (execL1612(var0,nondeterministic)) {
				ret = true;
				break L1611;
			}
		}
	...
	public boolean execL1612(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
