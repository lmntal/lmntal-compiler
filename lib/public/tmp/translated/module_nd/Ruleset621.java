...
"(nd.exec({$p, @p, {$q, @q}}) :- [:/*inline*/\t\t\tAtom out = me.nthAtom(0);\t\t\tAtom in = out.nthAtom(0);\t\t\tAtom plus = in.nthAtom(1);\t\t\tMembrane mem1 = (Membrane)in.getMem();\t\t\tIterator it = mem1.memIterator();\t\t\tMembrane mem2 = (Membrane)it.next();\t\t\t((Task)mem.getTask()).nondeterministicExec(mem2);\t\t\tmem.removeAtom(me);\t\t\tmem.removeAtom(out);\t\t\tmem1.removeAtom(in);\t\t\tplus.dequeue();\t\t\tmem1.removeAtom(plus);\t\t:]({$p, @p, {$q, @q}}))";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1727(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@621", "exec");
			return true;
		}
	...
	public boolean execL1727(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L1727:
										...
										if (!(!(f1).equals(((Atom)var5).getFunctor()))) {
											...
											while (it2.hasNext()) {
												...
												if (mem.lock()) {
													var6 = mem;
													if (nondeterministic) {
														Task.states.add(new Object[] {theInstance, "exec", "L1719",var0,var4,var6,var1,var2,var5,var3});
													} else if (execL1719(var0,var4,var6,var1,var2,var5,var3,nondeterministic)) {
														ret = true;
														break L1727;
													}
	...
	public boolean execL1719(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, boolean nondeterministic) {
		Object var7 = null;
		Object var8 = null;
		Object var9 = null;
		Object var10 = null;
...
L1719:
	...
	public boolean execL1720(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L1720:
		{
			if (execL1722(var0, var1, nondeterministic)) {
				ret = true;
				break L1720;
			}
...
L1725:
													...
													if (!(((AbstractMembrane)var0) != ((AbstractMembrane)var3))) {
														...
														while (it1.hasNext()) {
															...
															if (mem.lock()) {
																var13 = mem;
																if (nondeterministic) {
																	Task.states.add(new Object[] {theInstance, "exec", "L1719",var0,var2,var13,var11,var8,var1,var5});
																} else if (execL1719(var0,var2,var13,var11,var8,var1,var5,nondeterministic)) {
																	ret = true;
																	break L1725;
																}
	...
	public boolean execL1722(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
											...
											if (!(!(f1).equals(((Atom)var10).getFunctor()))) {
												...
												while (it1.hasNext()) {
													...
													if (mem.lock()) {
														var12 = mem;
														if (nondeterministic) {
															Task.states.add(new Object[] {theInstance, "exec", "L1719",var0,var7,var12,var1,var3,var10,var6});
														} else if (execL1719(var0,var7,var12,var1,var3,var10,var6,nondeterministic)) {
															ret = true;
															break L1722;
														}
