...
L732:
		{
			if (execL729(var0,nondeterministic)) {
				ret = true;
				break L732;
			}
		}
	...
	public boolean execL729(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L729:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L730",var0});
			} else if (execL730(var0,nondeterministic)) {
				ret = true;
				break L729;
			}
		}
