...
public class Ruleset626 extends Ruleset {
	private static final Ruleset626 theInstance = new Ruleset626();
	private Ruleset626() {}
	public static Ruleset626 getInstance() {
		return theInstance;
	}
	private int id = 626;
...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL1993(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@626", "null");
			return true;
		}
	...
	public boolean execL1993(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L1993:
		{
			if (execL1990(var0,nondeterministic)) {
				ret = true;
				break L1993;
			}
		}
	...
	public boolean execL1990(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L1990:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L1991",var0});
			} else if (execL1991(var0,nondeterministic)) {
				ret = true;
				break L1990;
			}
		}
	...
	public boolean execL1991(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L1991:
		{
			...
			var1 = mem;
			((AbstractMembrane)var1).loadRuleset(Ruleset625.getInstance());
			func = f0;
	...
	public boolean execL1992(Object var0, Object var1, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
