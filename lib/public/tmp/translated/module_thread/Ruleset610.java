...
"(thread_at_0 @@ thread.at(N, {$p, @p}) :- int(N) | thread.at2(N, {{$p, @p}}))";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL276(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@610", "thread_at_0");
			return true;
		}
	...
	public boolean execL276(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L276:
									...
									if (mem.lock()) {
										...
										if (!(link.getPos() != 0)) {
											...
											if (!(!(f1).equals(((Atom)var5).getFunctor()))) {
												if (nondeterministic) {
													Task.states.add(new Object[] {theInstance, "thread_at_0", "L268",var0,var4,var1,var2,var5,var3,var6});
												} else if (execL268(var0,var4,var1,var2,var5,var3,var6,nondeterministic)) {
													ret = true;
													break L276;
												}
											}
	...
	public boolean execL268(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, boolean nondeterministic) {
		Object var7 = null;
		Object var8 = null;
		Object var9 = null;
		Object var10 = null;
												...
												if (mem.lock()) {
													...
													if (!(mem == null)) {
														...
														if (!(((AbstractMembrane)var0) != ((AbstractMembrane)var3))) {
															if (nondeterministic) {
																Task.states.add(new Object[] {theInstance, "thread_at_0", "L268",var0,var2,var11,var8,var1,var5,var14});
															} else if (execL268(var0,var2,var11,var8,var1,var5,var14,nondeterministic)) {
																ret = true;
																break L274;
															}
														}
										...
										if (mem.lock()) {
											...
											if (!(link.getPos() != 0)) {
												...
												if (!(!(f1).equals(((Atom)var11).getFunctor()))) {
													...
													var12 = link;
													if (nondeterministic) {
														Task.states.add(new Object[] {theInstance, "thread_at_0", "L268",var0,var8,var1,var4,var11,var7,var13});
													} else if (execL268(var0,var8,var1,var4,var11,var7,var13,nondeterministic)) {
														ret = true;
														break L271;
													}
												}
