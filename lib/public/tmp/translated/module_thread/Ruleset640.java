...
public class Ruleset640 extends Ruleset {
	private static final Ruleset640 theInstance = new Ruleset640();
	private Ruleset640() {}
	public static Ruleset640 getInstance() {
		return theInstance;
	}
	private int id = 640;
...
"(thread_at2_0 @@ thread.at2(N, {{$p, @p}}), thread(M, {$q, @q}) :- int(N), int(M), '=:='(M, '+'(N, 1)) | thread(M, {$p, $q, @p, @q}))";
	...
	public boolean react(Membrane mem, Atom atom) {
		...
		if (execL2366(mem, atom, false)) {
			if (Env.fTrace)
				Task.trace("-->", "@640", "thread_at2_0");
			return true;
		}
		return result;
	}
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL2378(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@640", "thread_at2_0");
			return true;
		}
	...
	public boolean execL2378(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L2378:
																									...
																									if (!(((AbstractMembrane)var4).getAtomCount() != 1)) {
																										if (!(((AbstractMembrane)var4).getMemCount() != 1)) {
																											if (!(((AbstractMembrane)var4).hasRules())) {
																												if (nondeterministic) {
																													Task.states.add(new Object[] {theInstance, "thread_at2_0", "L2365",var0,var4,var11,var6,var1,var10,var2,var9,var5,var3,var7,var8,var12,var13,var14,var15});
																												} else if (execL2365(var0,var4,var11,var6,var1,var10,var2,var9,var5,var3,var7,var8,var12,var13,var14,var15,nondeterministic)) {
																													ret = true;
																													break L2378;
																												}
																											}
	...
	public boolean execL2365(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7, Object var8, Object var9, Object var10, Object var11, Object var12, Object var13, Object var14, Object var15, boolean nondeterministic) {
		Object var16 = null;
		Object var17 = null;
		Object var18 = null;
		Object var19 = null;
...
L2365:
	...
	public boolean execL2366(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2366:
		{
			if (execL2368(var0, var1, nondeterministic)) {
				ret = true;
				break L2366;
			}
			if (execL2373(var0, var1, nondeterministic)) {
				ret = true;
				break L2366;
			}
			if (execL2376(var0, var1, nondeterministic)) {
				ret = true;
				break L2366;
			}
		}
	...
	public boolean execL2376(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2376:
																											...
																											if (!(((AbstractMembrane)var21).getAtomCount() != 1)) {
																												if (!(((AbstractMembrane)var21).getMemCount() != 1)) {
																													if (!(((AbstractMembrane)var21).hasRules())) {
																														if (nondeterministic) {
																															Task.states.add(new Object[] {theInstance, "thread_at2_0", "L2365",var0,var21,var26,var2,var14,var11,var17,var8,var24,var20,var1,var5,var27,var28,var29,var30});
																														} else if (execL2365(var0,var21,var26,var2,var14,var11,var17,var8,var24,var20,var1,var5,var27,var28,var29,var30,nondeterministic)) {
																															ret = true;
																															break L2376;
																														}
																													}
	...
	public boolean execL2373(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2373:
																												...
																												if (!(((AbstractMembrane)var2).getAtomCount() != 1)) {
																													if (!(((AbstractMembrane)var2).getMemCount() != 1)) {
																														if (!(((AbstractMembrane)var2).hasRules())) {
																															if (nondeterministic) {
																																Task.states.add(new Object[] {theInstance, "thread_at2_0", "L2365",var0,var2,var26,var14,var11,var23,var8,var20,var1,var5,var15,var17,var27,var28,var29,var30});
																															} else if (execL2365(var0,var2,var26,var14,var11,var23,var8,var20,var1,var5,var15,var17,var27,var28,var29,var30,nondeterministic)) {
																																ret = true;
																																break L2373;
																															}
																														}
	...
	public boolean execL2368(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
																										...
																										if (!(((AbstractMembrane)var8).getAtomCount() != 1)) {
																											if (!(((AbstractMembrane)var8).getMemCount() != 1)) {
																												if (!(((AbstractMembrane)var8).hasRules())) {
																													if (nondeterministic) {
																														Task.states.add(new Object[] {theInstance, "thread_at2_0", "L2365",var0,var8,var25,var13,var1,var22,var4,var19,var11,var7,var14,var16,var26,var27,var28,var29});
																													} else if (execL2365(var0,var8,var25,var13,var1,var22,var4,var19,var11,var7,var14,var16,var26,var27,var28,var29,nondeterministic)) {
																														ret = true;
																														break L2368;
																													}
																												}
