...
public class Ruleset633 extends Ruleset {
	private static final Ruleset633 theInstance = new Ruleset633();
	private Ruleset633() {}
	public static Ruleset633 getInstance() {
		return theInstance;
	}
	private int id = 633;
...
"(_0 @@ {thread(N, {$p, @p}), $q, @q}/ :- int(N) | {$p, $q, @q})";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL2241(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@633", "_0");
			return true;
		}
	...
	public boolean execL2241(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L2241:
												...
												if (mem.lock()) {
													...
													if (!(link.getPos() != 0)) {
														...
														if (!(!(f1).equals(((Atom)var6).getFunctor()))) {
															if (nondeterministic) {
																Task.states.add(new Object[] {theInstance, "_0", "L2234",var0,var1,var5,var2,var3,var6,var4,var7});
															} else if (execL2234(var0,var1,var5,var2,var3,var6,var4,var7,nondeterministic)) {
																ret = true;
																break L2241;
															}
														}
	...
	public boolean execL2234(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7, boolean nondeterministic) {
		Object var8 = null;
		Atom atom;
		Functor func;
		Link link;
...
L2234:
	...
	public boolean execL2235(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2235:
		{
			if (execL2239(var0, var1, nondeterministic)) {
				ret = true;
				break L2235;
			}
		}
	...
	public boolean execL2239(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
															...
															if (!(mem == null)) {
																...
																if (!(!((AbstractMembrane)var3).isStable())) {
																	if (!(((AbstractMembrane)var0) != ((AbstractMembrane)var4))) {
																		if (nondeterministic) {
																			Task.states.add(new Object[] {theInstance, "_0", "L2234",var0,var3,var2,var12,var9,var1,var6,var15});
																		} else if (execL2234(var0,var3,var2,var12,var9,var1,var6,var15,nondeterministic)) {
																			ret = true;
																			break L2239;
																		}
																	}
