...
L756:
												...
												if (mem.lock()) {
													...
													if (!(link.getPos() != 0)) {
														...
														if (!(!(f1).equals(((Atom)var6).getFunctor()))) {
															if (nondeterministic) {
																Task.states.add(new Object[] {theInstance, "_0", "L749",var0,var1,var5,var2,var3,var6,var4,var7});
															} else if (execL749(var0,var1,var5,var2,var3,var6,var4,var7,nondeterministic)) {
																ret = true;
																break L756;
															}
														}
	...
	public boolean execL749(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7, boolean nondeterministic) {
		Object var8 = null;
		Atom atom;
		Functor func;
		Link link;
															...
															if (!(mem == null)) {
																...
																if (!(!((AbstractMembrane)var3).isStable())) {
																	if (!(((AbstractMembrane)var0) != ((AbstractMembrane)var4))) {
																		if (nondeterministic) {
																			Task.states.add(new Object[] {theInstance, "_0", "L749",var0,var3,var2,var12,var9,var1,var6,var15});
																		} else if (execL749(var0,var3,var2,var12,var9,var1,var6,var15,nondeterministic)) {
																			ret = true;
																			break L754;
																		}
																	}
