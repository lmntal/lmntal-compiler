...
public class Ruleset638 extends Ruleset {
	private static final Ruleset638 theInstance = new Ruleset638();
	private Ruleset638() {}
	public static Ruleset638 getInstance() {
		return theInstance;
	}
	private int id = 638;
...
"(thread_at_0 @@ thread.at(N, {$p, @p}) :- int(N) | thread.at2(N, {{$p, @p}}))";
	...
	public boolean react(Membrane mem, Atom atom) {
		...
		if (execL2328(mem, atom, false)) {
			if (Env.fTrace)
				Task.trace("-->", "@638", "thread_at_0");
			return true;
		}
		return result;
	}
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL2335(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@638", "thread_at_0");
			return true;
		}
	...
	public boolean execL2335(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
...
L2335:
									...
									if (mem.lock()) {
										...
										if (!(link.getPos() != 0)) {
											...
											if (!(!(f1).equals(((Atom)var5).getFunctor()))) {
												if (nondeterministic) {
													Task.states.add(new Object[] {theInstance, "thread_at_0", "L2327",var0,var4,var1,var2,var5,var3,var6});
												} else if (execL2327(var0,var4,var1,var2,var5,var3,var6,nondeterministic)) {
													ret = true;
													break L2335;
												}
											}
	...
	public boolean execL2327(Object var0, Object var1, Object var2, Object var3, Object var4, Object var5, Object var6, boolean nondeterministic) {
		Object var7 = null;
		Object var8 = null;
		Object var9 = null;
		Object var10 = null;
...
L2327:
	...
	public boolean execL2328(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2328:
		{
			if (execL2330(var0, var1, nondeterministic)) {
				ret = true;
				break L2328;
			}
			if (execL2333(var0, var1, nondeterministic)) {
				ret = true;
				break L2328;
			}
		}
	...
	public boolean execL2333(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
...
L2333:
												...
												if (mem.lock()) {
													...
													if (!(mem == null)) {
														...
														if (!(((AbstractMembrane)var0) != ((AbstractMembrane)var3))) {
															if (nondeterministic) {
																Task.states.add(new Object[] {theInstance, "thread_at_0", "L2327",var0,var2,var11,var8,var1,var5,var14});
															} else if (execL2327(var0,var2,var11,var8,var1,var5,var14,nondeterministic)) {
																ret = true;
																break L2333;
															}
														}
	...
	public boolean execL2330(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Object var5 = null;
										...
										if (mem.lock()) {
											...
											if (!(link.getPos() != 0)) {
												...
												if (!(!(f1).equals(((Atom)var11).getFunctor()))) {
													...
													var12 = link;
													if (nondeterministic) {
														Task.states.add(new Object[] {theInstance, "thread_at_0", "L2327",var0,var8,var1,var4,var11,var7,var13});
													} else if (execL2327(var0,var8,var1,var4,var11,var7,var13,nondeterministic)) {
														ret = true;
														break L2330;
													}
												}
