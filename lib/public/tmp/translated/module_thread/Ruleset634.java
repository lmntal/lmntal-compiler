...
public class Ruleset634 extends Ruleset {
	private static final Ruleset634 theInstance = new Ruleset634();
	private Ruleset634() {}
	public static Ruleset634 getInstance() {
		return theInstance;
	}
	private int id = 634;
...
"(_0 @@ thread.create(N) :- '>'(N, 0) | thread.num(N), thread.cre(N))";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL2266(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@634", "_0");
			return true;
		}
	...
	public boolean execL2266(Object var0, boolean nondeterministic) {
		Object var1 = null;
		Object var2 = null;
		Object var3 = null;
		Atom atom;
...
L2266:
		{
			...
			while (it1.hasNext()) {
				...
				if (!(!(((Atom)var3).getFunctor() instanceof IntegerFunctor))) {
					...
					if (!(!(x > y))) {
						if (nondeterministic) {
							Task.states.add(new Object[] {theInstance, "_0", "L2262",var0,var1,var2,var3});
						} else if (execL2262(var0,var1,var2,var3,nondeterministic)) {
							ret = true;
							break L2266;
						}
					}
	...
	public boolean execL2262(Object var0, Object var1, Object var2, Object var3, boolean nondeterministic) {
		Object var4 = null;
		Object var5 = null;
		Object var6 = null;
		Object var7 = null;
...
L2262:
	...
	public boolean execL2263(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Atom atom;
		Functor func;
		Link link;
...
L2263:
		{
			if (execL2265(var0, var1, nondeterministic)) {
				ret = true;
				break L2263;
			}
		}
	...
	public boolean execL2265(Object var0, Object var1, boolean nondeterministic) {
		Object var2 = null;
		Object var3 = null;
		Object var4 = null;
		Atom atom;
			...
			if (!(!(f1).equals(((Atom)var1).getFunctor()))) {
				if (!(((AbstractMembrane)var0) != ((Atom)var1).getMem())) {
					...
					if (!(!(((Atom)var4).getFunctor() instanceof IntegerFunctor))) {
						...
						if (!(!(x > y))) {
							if (nondeterministic) {
								Task.states.add(new Object[] {theInstance, "_0", "L2262",var0,var1,var3,var4});
							} else if (execL2262(var0,var1,var3,var4,nondeterministic)) {
								ret = true;
								break L2265;
							}
						}
