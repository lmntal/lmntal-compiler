...
"(initial rule)";
	...
	public boolean react(Membrane mem, boolean nondeterministic) {
		boolean result = false;
		if (execL906(mem, nondeterministic)) {
			if (Env.fTrace)
				Task.trace("==>", "@612", "null");
			return true;
		}
	...
	public boolean execL906(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
...
L906:
		{
			if (execL903(var0,nondeterministic)) {
				ret = true;
				break L906;
			}
		}
	...
	public boolean execL903(Object var0, boolean nondeterministic) {
		Atom atom;
		Functor func;
		Link link;
		AbstractMembrane mem;
...
L903:
		{
			if (nondeterministic) {
				Task.states.add(new Object[] {theInstance, "null", "L904",var0});
			} else if (execL904(var0,nondeterministic)) {
				ret = true;
				break L903;
			}
		}
