...
public class StreamDumper implements Runnable {
	 ...
	 */
	public void run() {
		if(true)System.out.println("StreamDumper: now starting dumping the console log of: " + processName);
		...
		while(true){
			try {
				...
				if (input == null){
					if(true)System.out.println("StreamDumper of: " + processName + " finished");
					break;
				} else {
