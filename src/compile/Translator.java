...
//	private BufferedWriter writer;
	...
	public Translator(InterpretedRuleset ruleset, boolean system) throws IOException {
		...
		outputFile = new File(dir, className + ".java");
		writer = new TranslatorWriter(new OutputStreamWriter(new FileOutputStream(outputFile), "EUC_JP"));
		//writer = new BufferedWriter(new OutputStreamWriter(System.out, Charset.forName("EUC_JP")));
		writer.write("// DO NOT EDIT THIS FILE.\n");
		writer.write("// This file was mechanically generated by GlobalSystemRulesetGenerator.\n\n");
		this.ruleset = ruleset;
...
//		}
		...
		if (globalSystemRuleset) {
			writer.write("/**\n");
			writer.write(" * Compiled system ruleset\n");
			writer.write(" */\n");
		}
