...
public class Node {
	...
	public Node(int id, HashSet<Integer> incoming, HashSet<Link> old, HashSet<Link> newer, HashSet<Link> next) {
		this.id = id;
	...
	public void printv() {
		System.out.println("Id: " + this.id);
		System.out.println("Incoming: " + this.incoming);
		Iterator<Link> oi = this.old.iterator();
		System.out.print("Old:");
		while(oi.hasNext()) System.out.print(" " + oi.next().getAtom());
		System.out.print("\n");
		Iterator<Link> newi = this.newer.iterator();
		System.out.print("New:");
		while(newi.hasNext()) System.out.print(" " + newi.next().getAtom());
		System.out.print("\n");
		Iterator<Link> nexti = this.next.iterator();
		System.out.print("Next:");
		while(nexti.hasNext()) System.out.print(" " + nexti.next().getAtom());
		System.out.print("\n");
	}
}
